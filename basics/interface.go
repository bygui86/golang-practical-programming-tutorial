...
// To implement an interface in Go, we just need to implement all the methods declared by the interface.
...
func main() {
	...
	// The circle and rect struct types both implement the geometry interface so we can
