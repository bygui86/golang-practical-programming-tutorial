...
func main() {
	...
	*a = *a * *a                        // what is the value of x now?
	fmt.Println("Third value of x", x)  // prints a value
	fmt.Println("Third value of a", *a) // prints a value

	fmt.Println("Reference of x:", &x) // prints a memory address
	fmt.Println("Reference of a:", a)  // prints a memory address
}
