...
/*
	...
	Here’s a variant on the example above that uses a custom type to explicitly represent an
	argument error.
*/
...
/*
	...
	This contrasts with the exceptions used in languages like Java and the overloaded single
	...
	PLEASE NOTE: Returning a nil value in the error position indicates that there was no error.
*/
func main() {
